...
public class Registration extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String name = request.getParameter("txtname"), emailid = request.getParameter("email"),
				mobile = request.getParameter("txtmobile"), password = request.getParameter("txtpwd"),
				address = request.getParameter("txtaddress"), gender = request.getParameter("gender");
