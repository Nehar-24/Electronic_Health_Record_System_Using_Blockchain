      ...
      <div class="logo">
       ...
       <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="HInsurancePatient.jsp">
             
              <p>Upload Insurance Patient</p>
            </a>
          </li>
           <li class="nav-item ">
            <a class="nav-link" href="HNew_ProfileUpdate.jsp">
             
              <p>Upload User Profile</p>
            </a>
          </li>
          <li class="nav-item ">
                     ...
                     <thead class=" text-primary">
                      ...
                      <%
										...
										try {
											...
											quer = "select * from tblinfoinsurance";
...
<td>
<input type="text" name="txtpname" value="<%=rs.getString(3)%>" readonly="readonly" />
</td>
<td>
<%=rs.getString(4) %>
</td>
