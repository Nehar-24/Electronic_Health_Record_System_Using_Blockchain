...
if(request.getParameter("Assign")!=null){
	   out.println("<script>alert('Dealer Assign Successfully...');</script>"); 
	}
%>
<body class="">
  <div class="wrapper ">
            ...
            <div class="col-lg-12 col-md-12">
              <div class="card">
                <div class="card-header card-header-warning">
                  <h4 class="card-title">Medicines Order Tracking System</h4>
                ...
                %>
                  ...
                  <%
					...
					<h3 align="center">Not Product is pending</h3>
                </div>
              </div>
            </div>
          </div>
